...
description: Use when reading or editing files under Data/Scripts/ in this Pokemon Essentials repo — before adding a method, tracing a global, following a scene transition, or touching a GameData:: class. Covers RGSS/pb-prefixed procedural conventions mixed with newer GameData::/Battle::/UI:: class code, and the load order across numbered script folders.
---
...
| 004_Game classes | Legacy `Game_*` RGSS classes | `$game_map`, `$game_player`, `$game_system` |
